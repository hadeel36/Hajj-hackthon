...
/**
 * This is the model class for table "bus_supervisor".
 *
 * The followings are the available columns in table 'bus_supervisor':
 * @property string $id
 ...
 */
class BusSupervisor extends CActiveRecord
{
    /**
     ...
     * @return BusSupervisor the static model class
     */
